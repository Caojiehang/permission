...
<div class="page-header">
    <h1>
        ...
        <small>
            ...
            Manage permission related module update history
        </small>
    </h1>
</div>
        ...
        $(function () {
            ...
            function renderLogListAndPage(result, url) {
                if (result.ret) {
                    if (result.data.total > 0) {
                        var rendered = Mustache.render(logListTemplate, {
                                ...
                                return function (text, render) {
                                    ...
                                    switch (this.type) {
                                        ...
                                        case 5:
                                            ...
                                            break;
                                        case 6:
                                            typeStr = "Role and Permission";
                                            break;
                                        case 7:
                                            typeStr = "Role and User";
                                            break;
                                        default:
                                            typeStr = "Unknown";
                                    }
                            ...
                            "showOldValue": function () {
                                return function (text, render) {
                                    return this.oldValue ? ((this.type == 6 || this.type == 7) ? this.oldValue : formatJson(this.oldValue)) : 'null';
                                }
                            },
                            "showNewValue": function () {
                                return function (text, render) {
                                    return this.newValue ? ((this.type == 6 || this.type == 7) ? this.newValue : formatJson(this.newValue)) : 'null';
                                }
                            }
                        });
                    ...
                    showMessage("Obtain operation log list", result.msg, false);
                }
            }
            ...
            function bindLogClick() {
                $(".log-edit").click(function (e) {
                    ...
                    console.log(logId);
                    if (confirm("Confirm to recovery this operation?")) {
                        $.ajax({
                            ...
                            success: function (result) {
                                if (result.ret) {
                                    showMessage("Recovery", "Successfully", true);
                                    loadLogList();
                                } else {
                                    showMessage("Recovery", result.msg, false);
                                }
                            }
                        });
                    }
